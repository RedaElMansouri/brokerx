...
### 1. Placement d'Ordre avec Validation Concurrence
 ![Placement_ordre_with_validation](../assets/process_view/placement_ordre_w_validation.png)

### 2. Appariement d'Ordres en Temps Réel

![Appariement_ordre_realTime](../assets/process_view/appariement_ordre_realTime.png)
...
![Architect_Phase3](../assets/process_view/architect.png)
